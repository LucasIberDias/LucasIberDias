...
<!-- Estatísticas do GitHub e Top Languages lado a lado -->
...
<!-- Cartões automáticos de repositórios lado a lado -->
<div align="center" style="display: flex; justify-content: center; gap: 30px; flex-wrap: wrap;">
...
<details align="center" style="color:#D7CCC8; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 700px; margin: auto;">
  <summary style="font-size: 18px; font-weight: bold; cursor: pointer; color:#D7CCC8;">
    Mais Informações
  </summary>
  ...
  <div align="center">
    <h3 style="margin-bottom: 10px;">Cursos e Certificados</h3>
  </div>

  <p align="center" style="font-size: 16px; line-height: 1.5;">
    📚 Aqui vou adicionar futuramente meus certificados, como os da 
    <a href="https://www.dio.me/" target="_blank" style="color:#8B5E3C; font-weight: bold; text-decoration: none;">DIO</a>.  
  ...
  <div align="center" style="margin-top: 10px;">
    <a href="https://www.dio.me/" target="_blank">
      <img src="https://hermes.digitalinnovation.one/assets/diome/logo-full.svg" alt="DIO" width="120" style="border-radius: 8px;" />
    </a>
    <br>
    <sub style="color:#D7CCC8;">Certificado Exemplo - <a href="LINK_DO_CERTIFICADO" style="color:#8B5E3C; text-decoration: none;">ver certificado</a></sub>
  </div>
